...
var LanguageService = class _LanguageService {
  ...
  updateLanguage(lang) {
    return __async(this, null, function* () {
      if (!lang)
        lang = this.userAgendLanguage;
      this.userLanguage = yield this.replaceUnsupportedLangauge(lang);
  ...
  replaceUnsupportedLangauge(lang) {
    return __async(this, null, function* () {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-S6YPVKVZ.js.map
