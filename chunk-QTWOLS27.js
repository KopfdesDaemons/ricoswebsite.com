...
function addPairToJSMap(ctx, map2, {
  key,
  value
}) {
...
var intResolve = (str, offset, radix, {
  intAsBigInt
...
function intResolve2(str, offset, radix, {
  intAsBigInt
}) {
  const sign = str[0];
...
var schema3 = [map, seq, string, nullTag, trueTag, falseTag, intBin, intOct2, int2, intHex2, floatNaN2, floatExp2, float2, binary, merge, omap, pairs, set, intTime, floatTime, timestamp];

// node_modules/yaml/browser/dist/schema/tags.js
var schemas = /* @__PURE__ */ new Map([["core", schema], ["failsafe", [map, seq, string]], ["json", schema2], ["yaml11", schema3], ["yaml-1.1", schema3]]);
var tagsByName = {
  binary,
  bool: boolTag,
  float,
...
function resolveBlockMap({
  composeNode: composeNode2,
  composeEmptyNode: composeEmptyNode2
}, ctx, bm, onError, tag) {
...
function resolveFlowCollection({
  ...
  for (let i = 0; i < fc.items.length; ++i) {
    ...
    if (!props.found) {
      ...
      if (!isMap2 && ctx.options.strict && containsNewline(key)) onError(
        key,
...
//# sourceMappingURL=chunk-QTWOLS27.js.map
